...
While not required under the LICENSE, Earlham Institute explicitly asks any party that wishes to deploy a copy (modified or not) of BIP on their own servers, to contact us at
