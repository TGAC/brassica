class Submission::PlantPopulationFinalizer
  ...
  def create_plant_population
    attrs = {
      ...
      female_parent_line: PlantLine.find_by!(plant_line_name: submission.content.step03.female_parent_line),
      male_parent_line: PlantLine.find_by!(plant_line_name: submission.content.step03.male_parent_line),
    }
  ...
  def create_plant_population_lists
    @plant_population_lists = submission.content.step03.plant_line_list.map do |plant_line_name|
