...
# NOTE: work around the inability to paser space-separated lists of values for a single arg
options[:phenos] += ARGV.to_a

gwas_results_path = File.join(options[:rails_root], "spec", "fixtures", "files", "gwas-results.csv")
